...
import math
import thisisatest_epy_block_0 as epy_block_0  # embedded python block
import thisisatest_epy_block_0_0 as epy_block_0_0  # embedded python block
import time
import threading
...
class thisisatest(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "thisisatest", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("thisisatest")
        ...
        self.settings = Qt.QSettings("GNU Radio", "thisisatest")
        ...
        def _variable_function_probe_0_0_probe():
          while True:
            ...
            val = self.epy_block_0_0.change_channel(1)
            try:
              try:
        ...
        def _variable_function_probe_0_probe():
          while True:
            ...
            val = self.epy_block_0.change_channel(1)
            try:
              try:
...
def main(top_block_cls=thisisatest, options=None):
